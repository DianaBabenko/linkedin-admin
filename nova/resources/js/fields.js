...
// Currency Field...
Vue.component('index-currency-field', require('./components/Index/CurrencyField.vue'));
Vue.component('detail-currency-field', require('./components/Detail/CurrencyField.vue'));
Vue.component('form-currency-field', require('./components/Form/CurrencyField.vue'));
...
// Boolean Group Field
Vue.component('index-boolean-group-field', require('./components/Index/BooleanGroupField.vue'));
Vue.component('detail-boolean-group-field', require('./components/Detail/BooleanGroupField.vue'));
Vue.component('form-boolean-group-field', require('./components/Form/BooleanGroupField.vue'));
...
Vue.component('index-morph-to-action-target-field', require('./components/Index/MorphToActionTargetField.vue'));

Vue.component('detail-morph-to-field', require('./components/Detail/MorphToField.vue'));

Vue.component('detail-morph-to-action-target-field', require('./components/Detail/MorphToActionTargetField.vue'));

Vue.component('form-morph-to-field', require('./components/Form/MorphToField.vue'));

// Spark Line Field...
Vue.component('index-sparkline-field', require('./components/Index/SparklineField.vue'));
Vue.component('detail-sparkline-field', require('./components/Detail/SparklineField.vue'));
